...
export default function ClusteringPage() {
  ...
  return (
    <div className="min-h-[800px] h-auto flex flex-col lg:flex-row overflow-auto bg-background">
      {/* Left Sidebar - Control Panel - Only show for clustering tabs */}
      {!["company-rating", "company-scoring"].includes(activeTab) && (
        <div className="w-full lg:w-80 lg:min-w-[280px] lg:max-w-[400px] xl:w-96 bg-card border-r border-border flex flex-col lg:min-h-[800px]">
          {/* Header */}

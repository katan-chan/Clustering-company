...
export default function ResultsPanel() {
  ...
  if (!results) {
    return (
      <div className="w-80 min-w-[280px] max-w-[400px] lg:w-80 xl:w-96 bg-card border-l border-border p-6">
  ...
  return (
    <div className="w-80 min-w-[280px] max-w-[400px] lg:w-80 xl:w-96 bg-card border-l border-border flex flex-col">
        ...
        <div className="p-6 space-y-6">
          ...
          {(results as any).projectionImages && Object.keys((results as any).projectionImages).length > 0 && (
            <div className="space-y-3">
              ...
              {Object.entries((results as any).projectionImages).map(([plotType, imageUrl]: [string, string]) => (
                <Card 
                  key={plotType} 
                  className="overflow-hidden cursor-pointer hover:ring-2 hover:ring-primary transition-all" 
                  data-testid={`projection-${plotType}`}
                  onClick={() => setSelectedProjectionType(plotType)}
                >
          ...
          {(results as any).metricImages && Object.keys((results as any).metricImages).length > 0 && (
            <div className="space-y-3">
              ...
              {Object.entries((results as any).metricImages).map(([metricType, imageUrl]: [string, string]) => (
